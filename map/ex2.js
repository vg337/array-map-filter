...
function getFoodCategories(foods) {
    return foods.map(function(veggie){
        if (veggie.isVegetarian == true){
            return (veggie.food + " is suitable for vegetarians");
        }
        else {
            return (veggie.food + " is not suitable for vegetarians")
        }
    });
}
